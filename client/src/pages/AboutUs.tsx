      ...
      <section className="py-20 bg-gradient-to-b from-background to-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 rounded-2xl w-full h-80 md:h-[400px] bg-muted overflow-hidden flex items-center justify-center">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="mb-8">
                ...
                <p className="text-muted-foreground mb-6">
                  To empower businesses to thrive in the digital world by providing innovative, scalable, and results-driven digital solutions that create exceptional user experiences and drive business growth.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground font-medium">Excellence</h4>
                      <p className="text-muted-foreground text-sm">
                        We are committed to delivering exceptional quality in everything we do, exceeding expectations with every project.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground font-medium">Innovation</h4>
                      <p className="text-muted-foreground text-sm">
                        We embrace creativity and forward-thinking approaches to solve complex challenges and push the boundaries of what's possible.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground font-medium">Integrity</h4>
                      <p className="text-muted-foreground text-sm">
                        We operate with honesty, transparency, and ethical standards in all our business relationships and practices.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground font-medium">Client-Centricity</h4>
                      <p className="text-muted-foreground text-sm">
                        We put our clients at the heart of everything we do, building long-term partnerships based on mutual trust and success.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground font-medium">Collaboration</h4>
                      <p className="text-muted-foreground text-sm">
                        We believe in the power of teamwork, fostering an environment where diverse ideas and perspectives lead to better solutions.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle">
              Meet the visionary leaders who guide our company's growth and success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-background rounded-xl overflow-hidden border border-border">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-6">
                  With over 15 years of experience in the tech industry, John leads our company with a vision for innovation and excellence.
                </p>
            ...
            <div className="bg-background rounded-xl overflow-hidden border border-border">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-6">
                  Jane oversees our technical strategy, ensuring we leverage cutting-edge technologies to deliver innovative solutions.
                </p>
                <div className="flex space-x-4">
                  <a href="#" className="text-muted-foreground hover:text-secondary transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                  </a>
            ...
            <div className="bg-background rounded-xl overflow-hidden border border-border">
              ...
              <div className="p-6">
                ...
                <p className="text-accent mb-4">Creative Director</p>
                <p className="text-muted-foreground mb-6">
                  Michael leads our design team, ensuring every project delivers exceptional user experiences and aesthetic appeal.
                </p>
                <div className="flex space-x-4">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Our Achievements</h2>
              <p className="text-muted-foreground mb-10">
                Over the years, our commitment to excellence has been recognized with numerous awards and accolades. Here's a snapshot of our achievements.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white">100+ International Awards</h3>
                    <p className="text-muted-foreground">
                      Recognized for excellence in web design, development, and digital marketing across global platforms.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white">Industry Recognition</h3>
                    <p className="text-muted-foreground">
                      Featured in leading publications and recognized as a top service provider in the digital industry.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white">500+ Successful Projects</h3>
                    <p className="text-muted-foreground">
                      Delivered over 500 successful projects across various industries with exceptional client satisfaction.
                    </p>
                  </div>
                </div>
              </div>
